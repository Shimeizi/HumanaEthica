...
Cypress.Commands.add('createDatabaseInfoForEnrollments', () => {
  ...
  // Create 3 shifts for activity A1
  cy.task('queryDatabase', {
    query: "INSERT INTO " + SHIFT_COLUMNS + generateShiftTuple(1, tomorrow.toISOString(), tomorrow.toISOString(), 5, 1),
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + SHIFT_COLUMNS + generateShiftTuple(10, dayAfterTomorrow.toISOString(), dayAfterTomorrow.toISOString(), 5, 1),
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + SHIFT_COLUMNS + generateShiftTuple(11, inThreeDays.toISOString(), inThreeDays.toISOString(), 5, 1),
    credentials: credentials,
  })
  cy.task('queryDatabase', {
...
Cypress.Commands.add('createDatabaseInfoForShifts', () => {
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + generateActivityTuple(1, "A1", "Shift management test activity", tomorrow.toISOString(), dayBeforeYesterday.toISOString(),
      inThirtyDays.toISOString(), 5, 1),
    credentials: credentials,
  })
});
